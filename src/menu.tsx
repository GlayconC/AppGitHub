...
const Menu: React.FC = () => {
  return (
    <nav className="bg-[#24292f] text-white pl-70 p-4 w-full">
       <p className="flex items-center ml-20">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" fill="currentColor" viewBox="0 0 50 50" className="mr-2">
            ...
            <span className="font-bold text-3xl">GitHub </span> &nbsp; &nbsp; &nbsp;/&nbsp; &nbsp; &nbsp;<span className='text-gray-400'>Profile</span>
        </p>
    </nav>
  );
};
